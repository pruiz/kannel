...
WsUInt32
ws_decode_mb_uint32(const unsigned char *buffer, size_t *len)
{
  WsUInt32 value = 0;
  size_t i;
...
WsBool
ws_encode_buffer(WsBuffer *buffer, ...)
{
  va_list ap;
  WsEncodingSpec spec;
  int ival;
...
size_t
ws_decode_buffer(const unsigned char *buffer, size_t buffer_len, ...)
{
  va_list ap;
  WsEncodingSpec spec;
  WsUInt8 *i8p;
