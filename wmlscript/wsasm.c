...
void
ws_asm_link(WsCompiler *compiler, WsAsmIns *ins)
{
...
void
ws_asm_print(WsCompiler *compiler)
{
  WsAsmIns *ins;
...
void
ws_asm_dasm(WsCompilerPtr compiler, const unsigned char *code, size_t len)
{
  size_t i = 0;
...
static WsAsmIns *
asm_alloc(WsCompiler *compiler, WsUInt16 type, WsUInt32 line)
{
...
WsAsmIns *
ws_asm_label(WsCompiler *compiler, WsUInt32 line)
{
...
WsAsmIns *
ws_asm_branch(WsCompiler *compiler, WsUInt32 line, WsUInt16 inst,
	      WsAsmIns *label)
{
...
WsAsmIns *
ws_asm_call(WsCompiler *compiler, WsUInt32 line, WsUInt8 findex)
{
...
WsAsmIns *
ws_asm_call_lib(WsCompiler *compiler, WsUInt32 line, WsUInt8 findex,
		WsUInt16 lindex)
{
...
WsAsmIns *
ws_asm_call_url(WsCompiler *compiler, WsUInt32 line, WsUInt16 findex,
...
WsAsmIns *
ws_asm_variable(WsCompiler *compiler, WsUInt32 line, WsUInt16 inst,
		WsUInt8 vindex)
{
  WsAsmIns *ins = asm_alloc(compiler, inst, line);
...
WsAsmIns *
ws_asm_load_const(WsCompiler *compiler, WsUInt32 line, WsUInt16 cindex)
{
