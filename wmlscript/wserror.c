...
void
ws_src_error(WsCompilerPtr compiler, WsUInt32 line, char *message, ...)
{
  va_list ap;
...
void
ws_src_warning(WsCompilerPtr compiler, WsUInt32 line, char *message, ...)
{
  va_list ap;
...
void
ws_fprintf(WsIOProc io, void *context, const char *fmt, ...)
{
  va_list ap;
...
void
ws_vfprintf(WsIOProc io, void *context, const char *fmt, va_list ap)
{
  int start, i;
...
void
ws_puts(WsIOProc io, void *context, const char *str)
{
...
void
ws_fputc(int ch, WsIOProc io, void *context)
{
  char c = (char) ch;
