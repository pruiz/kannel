...
WsPair *
ws_pair_new(WsCompilerPtr compiler, void *car, void *cdr)
{
...
WsList *
ws_list_new(WsCompiler *compiler)
{
...
static void
variable_hash_destructor(void *item, void *context)
{
  ws_free(item);
}
...
WsNamespace *
ws_variable_lookup(WsCompilerPtr compiler, char *name)
{
...
static void
pragma_use_hash_destructor(void *item, void *context)
{
  ws_free(item);
}
...
WsHashPtr
ws_pragma_use_hash_create(void)
{
...
void
ws_pragma_use(WsCompilerPtr compiler, WsUInt32 line, char *identifier,
	      WsUtf8String *url)
{
...
WsPragmaMetaBody *
ws_pragma_meta_body(WsCompilerPtr compiler, WsUtf8String *property_name,
		    WsUtf8String *content, WsUtf8String *scheme)
{
...
void
ws_pragma_meta_body_free(WsCompilerPtr compiler, WsPragmaMetaBody *mb)
{
  if (mb == NULL)
    return;
...
static void
function_hash_destructor(void *item, void *context)
{
  ws_free(item);
}
...
WsFunctionHash *
ws_function_hash(WsCompilerPtr compiler, char *name)
{
...
void
ws_function(WsCompiler *compiler, WsBool externp, char *name, WsUInt32 line,
	    WsList *params, WsList *block)
{
  WsFunctionHash *hash;
...
static WsExpression *
expr_alloc(WsCompiler *compiler, WsExpressionType type, WsUInt32 line)
{
...
WsExpression *
ws_expr_comma(WsCompilerPtr compiler, WsUInt32 line, WsExpression *left,
	      WsExpression *right)
{
...
WsExpression *
ws_expr_assign(WsCompilerPtr compiler, WsUInt32 line, char *identifier,
	       int op, WsExpression *expr)
{
...
WsExpression *
ws_expr_conditional(WsCompilerPtr compiler, WsUInt32 line,
...
WsExpression *
ws_expr_logical(WsCompilerPtr compiler, WsUInt32 line,
...
WsExpression *
ws_expr_binary(WsCompilerPtr compiler, WsUInt32 line,
	       int type, WsExpression *left, WsExpression *right)
{
...
WsExpression *
ws_expr_unary(WsCompilerPtr compiler, WsUInt32 line, int type,
...
WsExpression *
ws_expr_unary_var(WsCompilerPtr compiler, WsUInt32 line, WsBool addp,
		  char *variable)
{
...
WsExpression *
ws_expr_postfix_var(WsCompilerPtr compiler, WsUInt32 line, WsBool addp,
		    char *variable)
{
...
WsExpression *
ws_expr_call(WsCompiler *compiler, WsUInt32 line, int type, char *base,
	     char *name, WsList *arguments)
{
...
WsExpression *
ws_expr_symbol(WsCompiler *compiler, WsUInt32 line, char *identifier)
{
...
WsExpression *
ws_expr_const_invalid(WsCompiler *compiler, WsUInt32 line)
{
...
WsExpression *
ws_expr_const_true(WsCompiler *compiler, WsUInt32 line)
{
...
WsExpression *
ws_expr_const_false(WsCompiler *compiler, WsUInt32 line)
{
...
WsExpression *
ws_expr_const_integer(WsCompiler *compiler, WsUInt32 line, WsUInt32 ival)
{
...
WsExpression *
ws_expr_const_string(WsCompiler *compiler, WsUInt32 line, WsUtf8String *string)
{
...
static void
linearize_variable_init(WsCompiler *compiler, WsList *list, WsUInt32 line)
{
  WsNamespace *ns;
  WsListItem *li;
...
static WsStatement *
stmt_alloc(WsCompiler *compiler, WsStatementType type, WsUInt32 first_line,
	   WsUInt32 last_line)
{
...
WsStatement *
ws_stmt_block(WsCompiler *compiler, WsUInt32 fline, WsUInt32 lline,
	      WsList *block)
{
...
WsStatement *
ws_stmt_variable(WsCompilerPtr compiler, WsUInt32 line, WsList *variables)
{
...
WsStatement *
ws_stmt_expr(WsCompiler *compiler, WsUInt32 line, WsExpression *expr)
{
...
WsStatement *
ws_stmt_if(WsCompiler *compiler, WsUInt32 line, WsExpression *expr,
	   WsStatement *s_then, WsStatement *s_else)
{
...
WsStatement *
ws_stmt_for(WsCompilerPtr compiler, WsUInt32 line, WsList *init,
...
WsStatement *
ws_stmt_while(WsCompiler *compiler, WsUInt32 line, WsExpression *expr,
...
WsStatement *
ws_stmt_continue(WsCompiler *compiler, WsUInt32 line)
{
...
WsStatement *
ws_stmt_break(WsCompiler *compiler, WsUInt32 line)
{
...
WsStatement *
ws_stmt_return(WsCompilerPtr compiler, WsUInt32 line, WsExpression *expr)
{
