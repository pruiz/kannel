...
WsIeee754Result
ws_ieee754_encode_single(double value, unsigned char *buf)
{
  int sign = 0;
  WsInt32 exp = 0;
  WsUInt32 mant = 0;
...
WsIeee754Result
ws_ieee754_decode_single(unsigned char *buf, double *value_return)
{
...
WsUInt32
ws_ieee754_single_get_sign(unsigned char *buf)
{
  return (buf[0] & 0x80) >> 7;
}
...
WsUInt32
ws_ieee754_single_get_exp(unsigned char *buf)
{
...
WsUInt32
ws_ieee754_single_get_mant(unsigned char *buf)
{
...
void
ws_ieee754_print(unsigned char *buf)
{
  int i, j;
