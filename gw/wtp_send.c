 ...
 * direct input. Handles all errors by itself. Both wtp initiator and respond-
 * er use this function.
 */
 ...
 * pointers are worse. We must swap the source and the destination, because we
 * are answering a query.
 */
static void add_datagram_address(Msg *msg, WAPAddrTuple *address)
{
