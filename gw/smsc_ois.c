...
static int ois_convert_from_iso88591(char *raw, int len);
...
static int ois_convert_from_iso88591(char *raw, int len)
{
    ...
    static const char iso88591_to_gsm[] = {
	0x1b,0x1b,0x1b,0x1b,0x1b,0x1b,0x1b,0x1b, /* 0x00 - 0x07, something */
	0x1b,0x1b,'\n',0x1b,0x1b,'\r',0x1b,0x1b, /* 0x08 - 0x0f, something */
	0x1b,0x1b,0x1b,0x1b,0x1b,0x1b,0x1b,0x1b, /* 0x10 - 0x17, something */
	0x1b,0x1b,0x1b,0x1b,0x1b,0x1b,0x1b,0x1b, /* 0x18 - 0x1f, something */
	' ', '!', '"', '#', 0x02,'%', '&', '\'', /* 0x20 - 0x27 */
	'(', ')', '*', '+', ',', '-', '.', '/',  /* 0x28 - 0x2f */
	'0', '1', '2', '3', '4', '5', '6', '7',  /* 0x30 - 0x37 */
	'8', '9', ':', ';', '<', '=', '>', '?',  /* 0x38 - 0x3f */
	0x00,'A', 'B', 'C', 'D', 'E', 'F', 'G',  /* 0x40 - 0x47 */
	'H', 'I', 'J', 'K', 'L', 'M', 'N', 'O',  /* 0x48 - 0x4f */
	'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'W',  /* 0x50 - 0x57 */
	'X', 'Y', 'Z', 0x1b,0x1b,0x1b,0x1b,0x1b, /* 0x58 - 0x5f */
	0x1b,'a', 'b', 'c', 'd', 'e', 'f', 'g',  /* 0x60 - 0x67 */
	'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o',  /* 0x68 - 0x6f */
	'p', 'q', 'r', 's', 't', 'u', 'v', 'w',  /* 0x70 - 0x77 */
	'x', 'y', 'z', 0x1b,0x1b,0x1b,0x1b,0x1b, /* 0x78 - 0x7f */
	0x1b,0x1b,0x1b,0x1b,0x1b,0x1b,0x1b,0x1b, /* 0x80 - 0x87, something */
	0x1b,0x1b,0x1b,0x1b,0x1b,0x1b,0x1b,0x1b, /* 0x88 - 0x8f, something */
	0x1b,0x1b,0x1b,0x1b,0x1b,0x1b,0x1b,0x1b, /* 0x90 - 0x97, something */
	0x1b,0x1b,0x1b,0x1b,0x1b,0x1b,0x1b,0x1b, /* 0x98 - 0x9f, something */
	0x1b,0x40,'c' ,0x01,0x24,0x03,0x1b,0x5f, /* 0xa0 - 0xa7, not so good */
	0x1b,'c', 'A', '<', '-', '-', 'r', '-',  /* 0xa8 - 0xaf, not so good */
	'o', 0x1b,'2', '3' ,'\'','u', 0x1b,0x1b, /* 0xb0 - 0xb7, not so good */
	0x1b,'1', 'O', '>', 0x1b,0x1b,0x1b,0x60, /* 0xb8 - 0xbf, not so good */
	'A', 'A', 'A', 'A', 0x5b,0x0e,0x1c,0x09, /* 0xc0 - 0xc7, fairly good */
	'E', 0x1f,'E', 'E', 'I', 'I', 'I', 'I',  /* 0xc8 - 0xcf, fairly good */
	0x1b,0x5d,'O', 'O', 'O', 'O', 0x5c,0x1b, /* 0xd0 - 0xd7, fairly good */
	0x0b,'U', 'U', 'U', 0x5e,'Y', 0x1b,0x1b, /* 0xd8 - 0xdf, fairly good */
	0x7f,'a', 'a', 'a', 0x7b,0x0f,0x1d,'c',  /* 0xe0 - 0xe7, fairly good */
	0x04,0x05,'e', 'e', 0x07,'i', 'i', 'i',  /* 0xe8 - 0xef, fairly good */
	0x1b,0x7d,0x08,'o', 'o', 'o', 0x7c,0x1b, /* 0xf0 - 0xf7, fairly good */
	0x0c,0x06,'u', 'u', 0x7e,'y', 0x1b,0x1b  /* 0xf8 - 0xff, fairly good */
    };

    int i;

    SAY2(3, "ois_convert_from_iso88591 len=%d", len);

    for (i = 0; i < len; ++i) {
	raw[i] = iso88591_to_gsm[raw[i] & 0xff];
    }

    SAY2(5, "ois_convert_from_iso88591 gave [%s]", ois_debug_str(raw, i));
    return i;
}
