...
/*
 * Counter for GenTID (The global tid generated by initiator, see WTP 10.4.3). 
 */

static Counter *gen_tid_counter = NULL;

/*
 * We must set tid_new flag 1, when we are restarting the initiator. Otherwise
...
/*
 * Feed an event to a WTP initiator state machine. Handle all errors by itself, 
